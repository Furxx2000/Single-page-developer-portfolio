...
export default function ProjectImage({
  ...
  return (
    <div
      className='prj-image relative grid rounded-xl overflow-clip pointer-events-none xl:pointer-events-auto hover:after:opacity-75 after:opacity-0 after:inset-0 after:absolute after:bg-deep-black after:transition-opacity
